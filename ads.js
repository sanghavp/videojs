...
let player2 = videojs('content_video');
...
// Remove controls from the player2 on iPad to stop native controls from stealing
// our click
...
// Initialize the ad container when the video player2 is clicked, but only the
