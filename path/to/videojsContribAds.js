...
const { playMiddleware, isMiddlewareMediatorSupported: isMiddlewareMediatorSupported$1 } = obj;
...
const ContentState$2 = States.getState('ContentState');

class AdsDone extends ContentState$2 {
...
const obj$1 = { start, end };

const AdState$2 = States.getState('AdState');

/*
 * This state encapsulates waiting for prerolls, preroll playback, and
 * content restoration after a preroll.
 */
class Preroll extends AdState$2 {
...
const ContentState$3 = States.getState('ContentState');
 ...
 */
class BeforePreroll extends ContentState$3 {
...
const AdState$3 = States.getState('AdState');

class Midroll extends AdState$3 {
...
const AdState$4 = States.getState('AdState');

class Postroll extends AdState$4 {
...
const ContentState$4 = States.getState('ContentState');
 ...
 */
class ContentPlayback extends ContentState$4 {
...
const ContentState$5 = States.getState('ContentState');

/*
 * This state represents content playback when stitched ads are in play.
 */
class StitchedContentPlayback extends ContentState$5 {
...
const AdState$5 = States.getState('AdState');

class StitchedAdRoll extends AdState$5 {
...
const { isMiddlewareMediatorSupported } = obj;
