...
var dependencies = { "video.js": "^7.21.1", "videojs-contrib-ads": "^6.9.0" };
var scripts = { "rollup": "npm-run-all rollup:*", "rollup:max": "rollup -c configs/rollup.config.js", "rollup:contribAds:max": "rollup -c configs/contrib.rollup.config.js" };
var devDependencies = { "rollup": "^0.51.8", "rollup-plugin-babel": "^3.0.7", "rollup-plugin-copy": "^0.2.3", "rollup-plugin-json": "^2.3.1" };
var pkg = {
